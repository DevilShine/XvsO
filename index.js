...
wrapFieldClick.addEventListener("click", function (e) {
  ...
  if (checkWiner(0) == "O" && checkWiner(1) == "O" && checkWiner(2) == "O" || checkWiner(3) == "O" && checkWiner(4) == "O" && checkWiner(5) == "O" || checkWiner(6) == "O" && checkWiner(7) == "O" && checkWiner(8) == "O" || checkWiner(0) == "O" && checkWiner(3) == "O" && checkWiner(6) == "O" || checkWiner(1) == "O" && checkWiner(4) == "O" && checkWiner(7) == "O" || checkWiner(2) == "O" && checkWiner(5) == "O" && checkWiner(8) == "O" || checkWiner(0) == "O" && checkWiner(4) == "O" && checkWiner(8) == "O" || checkWiner(2) == "O" && checkWiner(4) == "O" && checkWiner(6) == "O") {
    for (var i = 0; i < 9; i++) {
      document.querySelector(".btn-" + i).innerHTML = "";
    }
    alert("WIner O");
